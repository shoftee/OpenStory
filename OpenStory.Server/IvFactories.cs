...
{
    static class IvFactories
    {
        #region EMS

        private static readonly byte[] EmsTable = new byte[] 
        {
        ...
        private static readonly byte[] EmsInitialValue = new byte[] { 0xF2, 0x53, 0x50, 0xC6 };

        private static readonly byte[] EmsAesKey = new byte[]
        {
        ...
        private static readonly byte[] KmstTable = new byte[] 
        {
            0xEC, 0x3F, 0x77, 0xA4, 0x45, 0xD0, 0x71, 0xBF, 0xB7, 0x98, 0x20, 0xFC, 0x4B, 0xE9, 0xB3, 0xE1,
            0x5C, 0x22, 0xF7, 0x0C, 0x44, 0x1B, 0x81, 0xBD, 0x63, 0x8D, 0xD4, 0xC3, 0xF2, 0x10, 0x19, 0xE0,
            0xFB, 0xA1, 0x6E, 0x66, 0xEA, 0xAE, 0xD6, 0xCE, 0x06, 0x18, 0x4E, 0xEB, 0x78, 0x95, 0xDB, 0xBA,
