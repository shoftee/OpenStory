...
namespace OpenStory.Server.Registry.Buddy
{
    internal sealed class BuddyList : IEnumerable<Buddy>
    {
        ...
        private LinkedList<BuddyEntryInfo> pendingRequests;
        ...
        private BuddyList(int capacity = DefaultCapacity)
        {
            ...
            this.pendingRequests = new LinkedList<BuddyEntryInfo>();
        }
        ...
        private void HandleRecord(IDataRecord record)
        {
            ...
            if (status == BuddyStatus.Pending)
            {
                ...
                this.pendingRequests.AddLast(new BuddyEntryInfo(buddyCharacterId, buddyName));
            }
