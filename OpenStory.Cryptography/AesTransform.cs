...
namespace OpenStory.Cryptography
{
    ...
    public sealed class AesTransform
    {
        ...
        /// </summary>
        private static readonly byte[] ShuffleTable = new byte[] 
        {
        ...
        /// <summary>
        /// The constant used to initialize the IV for the shuffle routine.
        /// </summary>
        private static readonly byte[] ShuffleConstant = new byte[] { 0xF2, 0x53, 0x50, 0xC6 };
        ...
        /// Thrown if <paramref name="iv"/> is <c>null</c>.
        /// </exception>
        ...
        public void Transform(byte[] data)
        {
            ...
            this.iv = ShuffleIvInternal(this.iv);
        }
        ...
        private static byte[] ShuffleIvInternal(byte[] iv)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                byte input = iv[i], tableInput = ShuffleTable[input];
        ...
        /// <summary>
        /// Shuffles the specified IV.
        /// </summary>
        /// <remarks>
        /// The array passed as an argument is not modified.
        /// </remarks>
        /// <param name="iv">The IV to shuffle.</param>
        /// <exception cref="ArgumentNullException">
        /// Thrown if <paramref name="iv"/> is <c>null</c>.
        ...
        /// </exception>
        /// <returns>The shuffled IV.</returns>
        public static byte[] ShuffleIV(byte[] iv)
        {
            return ShuffleIvInternal(iv);
        }
