...
namespace OpenStory.Common.IO
{
    ...
    public interface ISafePacketReader
    {
        ...
        /// <remarks>On failure to read all bytes, <paramref name="array"/> is assigned <c>null</c>.</remarks>
        ...
        /// <remarks>If the read was unsuccessful, <paramref name="result"/> is set to <c>null</c>.</remarks>
        ...
        /// <remarks>
        /// <para>If the read was unsuccessful, <paramref name="result"/> is set to <c>null</c>.</para>
        ...
        /// <remarks>
        /// <para>If the read was unsuccessful, <paramref name="value"/> is set to <c>false</c>.</para>
        /// <para>Otherwise, result is <c>true</c> if the byte that was read is not equal to 0,
