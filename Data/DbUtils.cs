...
namespace OpenMaple.Data
{
    ...
    {
        private static readonly string ConnectionString = Properties.Settings.Default.OpenMapleConnectionString;
        ...
        {
            int count = 0;
            foreach (var record in GetRecordSetIterator(query))
            {
        ...
        /// <param name="commandCallback">The callback for the work to do during this transaction.</param>
        public static void PerformTransaction(string transactionName, ILogger errorLogger, Action<SqlCommand> commandCallback)
        {
        ...
        /// <param name="commandCallback">The callback for the work to do during this transaction.</param>
        public static void PerformTransaction(string transactionName, IsolationLevel isolationLevel, Action<SqlCommand> commandCallback)
        {
        ...
        /// <param name="errorLogger">The error logging stream to use.</param>
        /// <param name="commandCallback">The callback for the work to do during this transaction.</param>
        public static void PerformTransaction(string transactionName, IsolationLevel isolationLevel, ILogger errorLogger, Action<SqlCommand> commandCallback)
        {
            using (SqlConnection connection = GetConnection())
