...
namespace OpenStory.Networking
{
    ...
    class SendDescriptor
    {
        ...
        /// </summary>
        /// <param name="container">The container of this SendDescriptor.</param>
        ...
        /// <summary>
        /// Encrypts a packet, adds a header to it, and writes it to the stream.
        /// </summary>
        ...
        /// <summary>
        /// Writes data directly to the stream, circumventing synchronization and encryption.</summary>
        /// <exception cref="ArgumentNullException">
