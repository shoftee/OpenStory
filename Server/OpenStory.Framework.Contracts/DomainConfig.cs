...
namespace OpenStory.Framework.Contracts
{
    ...
    {
        private const string KeyNotFoundFormat = "The configuration key '{0}' did not correspond to an existing entry.";
        ...
        public T Get<T>(string key, bool throwOnMissing = false)
        {
            ...
            {
                string message = string.Format(KeyNotFoundFormat, key);
