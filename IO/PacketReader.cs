...
namespace OpenMaple.IO
{
    ...
    class PacketReader
    {
        ...
        {
            return !(this.position + count > end);
        }
        ...
        public bool TryReadInt16(out short value)
        {
            ...
            value = BigEndianBitConverter.ToInt16(buffer, this.UncheckedAdvance(2));
            return true;
        }
        ...
        public bool TryReadInt32(out int value)
        {
            ...
            value = BigEndianBitConverter.ToInt16(buffer, this.UncheckedAdvance(4));
            return true;            
        }
        ...
        public bool TryReadInt64(out long value)
        {
            ...
            value = BigEndianBitConverter.ToInt64(buffer, this.UncheckedAdvance(8));
            return true;
        }
        ...
        public string ReadPaddedString(int length)
        {
            ...
            return ReadNullTerminatedString(start, length);
        }
